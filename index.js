...
module.exports = {
    ...
    init: async (router) => {
            ...
            try {
                ...
                async function lerPasta(dir, escopo) {
                    ...
                    for (const nome of arquivos.filter((n) => n.endsWith('.md'))) {
                        ...
                        docs.push({ slug: nome.replace(/\.md$/, ''), titulo: meta.titulo || nome, categoria: meta.categoria || 'geral', tags: meta.tags || [], atualizadoEm: meta.atualizadoEm || null, bytes: Buffer.byteLength(bruto, 'utf8'), escopo });
                    }
                    return docs;
                }
        ...
        router.post('/documento/escrever', async (req, res) => {
            try {
                const { personagem, slug, titulo, categoria, tags, conteudo, chatId } = req.body || {};
